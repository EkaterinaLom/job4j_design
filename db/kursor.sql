...
BEGIN;
DECLARE
    cursor_2_products SCROLL cursor for
                        select * from products;  
                        
FETCH LAST FROM cursor_2_products;     
MOVE BACKWARD 6 FROM cursor_2_products; 
FETCH NEXT FROM cursor_2_products;
MOVE BACKWARD 9 FROM cursor_2_products;
FETCH NEXT FROM cursor_2_products;
MOVE BACKWARD 6 FROM cursor_2_products; 
FETCH NEXT FROM cursor_2_products;
FETCH PRIOR FROM cursor_2_products;
CLOSE cursor_2_products;
COMMIT;
